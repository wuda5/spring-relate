...
public class BeanFactory {
    ...
    public void parseXml(String xml) throws LubanSpringException{
        ...
        try {
            ...
            for (Iterator<Element> itFirlst = elementRoot.elementIterator(); itFirlst.hasNext();) {
                ...
                Class clazz = Class.forName(clazzName);// 先反射得到其类对象模板
                 ...
                 * 如果有则注入
                 */
                Object object = generateBean(attribute, flag, elementFirstChil, clazz);
     ...
     * 如果有则注入
     */
    private Object generateBean(Attribute attribute, boolean flag, Element elementFirstChil, Class clazz)
            throws InstantiationException, IllegalAccessException, NoSuchFieldException, NoSuchMethodException, java.lang.reflect.InvocationTargetException {
        Object object = null;
        ...
        // 自动专配--
        object = outowireGenerateBean(attribute, flag, clazz, object);
        return object;
    }
    ...
    /**
       3.自动专配--
     */
    private Object outowireGenerateBean(Attribute attribute, boolean flag, Class clazz, Object object)
