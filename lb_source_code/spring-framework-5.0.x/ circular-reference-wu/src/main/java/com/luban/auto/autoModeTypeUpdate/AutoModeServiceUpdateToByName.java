 ...
 * 要说明的是，通过类型转配【将默认NO--> 改为了 AUTOWIRE_BY_Name】，--> 这样其实就能达到用xxx注解方式开发替换 xml中单个xxxs设置
 ...
 * */
@Component
public class AutoModeServiceUpdateToByName {
...
//	public void setOrderService(LuBanService orderService434) { --- 名字写成其他，注入不进去！！
	...
	public void test() {
		System.out.println("【 Auto.1.[byName]--update 】--test--取值"+LuBanService111);
	}
}
